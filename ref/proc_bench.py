...
for line in sys.stdin:
    # if line.startswith("Generating keypairs"):
    #     skip = True
    # if line.startswith("Keypairs generated"):
    #     skip = False
    #     continue
    #
    # if skip or line == "":
    ...
    if ":" in line:
        ...
        parsed = parse.parse(
            "{keygen_time:f} ({keygen_cyc:d} cycles)  {sign_time:f} ({sign_cyc:d} cycles)  {verify_time:f} ({verify_cyc:d} cycles)", line.strip())
