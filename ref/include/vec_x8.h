...
#define pmod_mat_x8_t __m512i
#define pmod_mat_mask_x8_t __mmask8

uint64_t extract_vec_x8(pmod_mat_x8_t x, int pos);
uint32_t extract_mask_x8(pmod_mat_mask_x8_t x, int pos);
