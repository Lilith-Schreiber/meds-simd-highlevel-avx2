...
void shake256_x8_absorb(keccak_state_x8 *state, const pmod_mat_x8_t *in, size_t inlen);
...
void shake256_x8_squeeze(pmod_mat_x8_t *out, size_t outlen, keccak_state_x8 *state);

#define shake256_x8_absorb_once FIPS202_NAMESPACE(shake256_x8_absorb_once)
void shake256_x8_absorb_once(keccak_state_x8 *state, const pmod_mat_x8_t *in, size_t inlen);

#define shake256_x8_squeezeblocks FIPS202_NAMESPACE(shake256_x8_squeezeblocks)
void shake256_x8_squeezeblocks(pmod_mat_x8_t *out, size_t nblocks,  keccak_state_x8 *state);

#define shake256_x8 FIPS202_NAMESPACE(shake256_x8)
void shake256_x8(pmod_mat_x8_t *out, size_t outlen, const pmod_mat_x8_t *in, size_t inlen);
